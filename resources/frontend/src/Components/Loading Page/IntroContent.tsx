        ...
        <div className="w-full lg:w-1/2 mx-auto space-y-6 mt-10 lg:mt-0 lg:ml-8">
            <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 w-full leading-relaxed">
                    ...
                    WebSubscribe monitors content changes and delivers
                    instant notifications straight to your inbox, so
            ...
            <div className="space-y-5 max-w-lg">
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-1">
                            Get notified with post titles and descriptions directly to your inbox
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold">Multi-Website Tracking</h3>
                        <p className="text-gray-400 mt-1">
                            Monitor multiple websites simultaneously with a single dashboard
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex space-x-4 pt-2">
                <button className="px-8 py-3 bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg transition duration-300 transform hover:-translate-y-1 shadow-lg shadow-green-500/20">
